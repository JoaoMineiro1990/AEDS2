...
public class TP02Q03 
{
    ...
    public static String pesq (int tamanho, Jogador[] jogadores , String pesquisado)
    {
        String resposta= "NAO";
        for(int i = 0; i < tamanho ; i++)
        {
            comp++;
            if((jogadores[i].getNome()).equals(pesquisado))
            {
                resposta="SIM";
                i = tamanho;
            } 
    ...
    public static void main (String [] args) throws IOException
    {
        ...
        String nomeDoArquivo = "816594_sequencial.txt";
        ...
        //fechando e abrindo de novo o scanner para reseta
        ...
        while(true)
        {
            ...
            System.out.println(pesq(i , jogadores , nomeJog));
        }
