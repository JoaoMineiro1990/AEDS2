...
public class TP02Q07 {
    ...
    public static void sort(int tamanho, Jogador[] jogadores) 
    {
        ...
        {
            Jogador tmp = jogadores[i].clone();
            int j = i - 1;
            
            while ((j >= 0) && (jogadores[j].getAnoNascimento() >= tmp.getAnoNascimento()))
            {
                comp++;
                if (jogadores[j].getAnoNascimento() == tmp.getAnoNascimento())
                {
                    ...
                    String nome1 = jogadores[j].getNome();
                    String nome2 = tmp.getNome();
    ...
    public static void main (String [] args) throws IOException
    {
        ...
        String nomeDoArquivo = "816594_insercao.txt";
